...
'''
将question修改为可以fine-tune的
few-shot, 每个类别几张图像, e.g., 16张图像
是否要留example? 不留的话给出的feature很差
'''
...
# Q: What are useful features for distinguishing a xxx in a photo?
# A: There are several useful visual features to tell there is a  xxx  in a photo:
